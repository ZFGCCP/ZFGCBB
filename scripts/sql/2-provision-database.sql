ALTER DEFAULT PRIVILEGES IN SCHEMA ZFGBB
...
CREATE TABLE IF NOT EXISTS ZFGBB.ATTRIBUTE_DATA_TYPE (
	ATTRIBUTE_DATA_TYPE_ID INTEGER DEFAULT NEXTVAL(
		'zfgbb.attribute_data_type_attribute_data_type_id_seq'::REGCLASS
	) NOT NULL,
...
CREATE OR REPLACE VIEW PUBLIC.CURRENT_MESSAGE_VIEW AS
SELECT
	M.MESSAGE_ID,
	M.OWNER_ID,
	M.THREAD_ID,
